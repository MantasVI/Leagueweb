...
<div class="  flex p-5 bg-black justify-between fixed w-full z-50 ">
   ...
   <div class='flex items-center'> 
       <a href='/Skins'>  <button id='btn2' class='p-3 bg-black border border-blue-900 ml-5 pr-10 pl-10 rounded-sm hover:border-[#C89B3C] hover:bg-[#0A1428] hover:transition-transform duration-300 '>Back</button></a>
...
<div class='grid grid-cols-4 justify-center items-center gap-y-30 gap-x-20  mt-30 border-2 border-[#C89B3C] p-20 bg-black ml-20 mr-20 mb-20 rounded-sm'>
